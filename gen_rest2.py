...
# Last inserted product_id is 634, so we need from index 255 onwards (product_id 635)
vals = []
for i in range(255, len(data)):
    pid = product_ids[i]
...
print('Remaining: %d entries for products %d to %d' % (len(vals), vals[0][0], vals[-1][0]))
